...
/**
 * The app itself. Loaded by main.tsx only AFTER the published register has
 * arrived, because every module that reads the register reads it once, when
 * it loads — see lib/spec/source.ts.
 */
