...
# FieldMetadata — the Round 6 register table — was retired by migration 0039
# (metadata v2, 25 Sep 2026). field_definitions + field_placements replaced it
# in Round 7 (0008); see FieldDefinition below.
